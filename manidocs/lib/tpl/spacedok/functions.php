 ...
 * Display the sidebar
 */
function spacedok_sidebar() {//func
...
/******  show main sidebar if necessary  ******/
  if (tpl_getConf('spacedok_main_sidebar') && $fileSidebar != $sidebar) {//do
    $ID = $sidebar;
    $REV = '';
...
//    tpl_content(false);
    echo "<hr>";
    }//if (tpl_getConf('spacedok_main_sidebar') && $fileSidebar != $sidebar) 
