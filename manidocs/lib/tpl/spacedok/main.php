 ...
 * spacedok template adapted froom minima by
 * @author Tony Baldwin <tonybaldwin@gmx.com>
 * live sample at http://tonybaldwin.me/hax
 */
...
<head>
  ...
  <title>
    <?php spacedok_nstitle(); tpl_pagetitle()?> · <?php echo strip_tags($conf['title'])?>
  </title>
...
<div class="dokuwiki" id="<?php spacedok_classID()?>">
  <?php html_msgarea()?>
